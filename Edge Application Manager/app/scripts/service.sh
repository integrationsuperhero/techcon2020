...
cp $PATH_TO_MODEL/model.js $PATH_TO_MODEL/model.js.original
...
while true; do
    ...
    echo "DEBUG *** : MMS metadata=$(cat objects.meta) HTTP_CODE=$HTTP_CODE"
    ...
    if [[ "$HTTP_CODE" == '200' && "$OBJ_ID" == $OBJECT_ID ]]; then
        ...
        if [[ "$DELETED" == "true" ]]; then
	        ...
	        #cp $PATH_TO_MODEL/model.js.original $PATH_TO_MODEL/model.js
            ...
            cp $OBJECT_ID $PATH_TO_MODEL/model.js
